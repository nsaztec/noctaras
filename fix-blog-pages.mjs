...
const CSS_INJECT = `
.theme-switch-wrapper { display: inline-flex; align-items: center; justify-content: center; transform: scale(0.65); transform-origin: center; margin-left: 1rem; }
...
const SVG_LOGO = `<svg width="24" height="24" viewBox="0 0 24 24" fill="none">
...
async function processFiles() {
  ...
  for (const file of files) {
    ...
    // 2. Wrap back button with nav-right & themeToggle (if missing)
    if (!content.includes('id="themeToggleBlog"')) {
      const backLinkStr = '<a class="nav-back" href="index.html">← All Articles</a>';
